        ...
        <div>
            ...
            <div class="row">
                <div *ngFor="let event of events" class="col-md-5">
                    ...
                    <!--#thumbnail is a template variable that can be used to interact with a child -->
                    <!--<h3>{{thumbnail.someProperty}}</h3>--> <!-- Bind directly to a template variable on a component -->
                    <!--<div class="btn btn-primary" (click)="thumbnail.logFoo()">Log me some foo</div>-->
                </div>
            </div>
